...
abstract class GetPaymentKeyCardRemoteDataSource {
  Future<String> getPaymentKeyCard(PaymentInfoModel paymentInfoModel);
}

class GetPaymentKeyCardRemoteDataSourceDIO
    extends GetPaymentKeyCardRemoteDataSource {
  @override
  Future<String> getPaymentKeyCard(PaymentInfoModel paymentInfoModel) async {
