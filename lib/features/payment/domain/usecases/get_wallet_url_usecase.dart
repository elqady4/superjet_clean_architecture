...
class GetWalletUrlUsecase extends Usecase<String, String> {
  final PaymentRepository paymentRepository;

  GetWalletUrlUsecase({required this.paymentRepository});
  @override
  Future<Either<Failure, String>> call(String params) {
    return paymentRepository.getWalletURL(params);
  }
}
